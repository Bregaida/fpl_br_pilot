...
/**
 * Representa uma frequÃƒÂªncia de rÃƒÂ¡dio disponÃƒÂ­vel em um aerÃƒÂ³dromo.
 */
public class Frequencia {
    ...
    // Fields with JavaDoc
    private final TipoFrequencia tipo;    // Tipo de frequÃƒÂªncia
    private final String descricao;       // DescriÃƒÂ§ÃƒÂ£o da frequÃƒÂªncia (ex: "Torre Principal")
    private final String valor;           // Valor da frequÃƒÂªncia (ex: "118.10")
    private String horarioFuncionamento;  // HorÃƒÂ¡rio de funcionamento (ex: "24H", "HORÃƒÂRIO DE VOO")
