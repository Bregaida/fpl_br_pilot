...
/**
 * DTO para representaÃƒÂ§ÃƒÂ£o de uma frequÃƒÂªncia de rÃƒÂ¡dio na camada de apresentaÃƒÂ§ÃƒÂ£o.
 */
public class FrequenciaDTO {
    ...
    /**
     * Converte este DTO para uma entidade de domÃƒÂ­nio Frequencia.
     */
